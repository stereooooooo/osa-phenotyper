...
**Patient:** F, BMI 24, **no study**, ESS 7 / ISI 20  
**Phenotypes:** _none_  
**Plan (ranked):** `SLEEP-STUDY, CBTI`
...
### 3. Normal AHI
**Patient:** F, BMI 25, AHI 3 (normal)  
**Phenotypes:** _none_  
**Plan:** _none_


### 4. Mild positional
**Patient:** M, BMI 28, AHI 8 (supine 18 / non-supine 4)  
**Phenotypes:** Positional OSA  
**Plan (ranked):** `CPAP, POS, MAD-FAVORABLE, MAD-WORKUP`
...
### 5. Moderate classic
**Patient:** M, BMI 32, AHI 22 (sleepy)  
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, WEIGHT, MAD, MAD-WORKUP, SURGERY-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP`
...
**Plan (ranked):** `CPAP, WEIGHT, SURG, SURGALT, SURGERY-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP`
...
**Phenotypes:** High Anatomical Contribution, High Hypoxic Burden  
**Plan (ranked):** `CPAP, WEIGHT, SURG, SURGALT, HB-URG, SURGERY-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP`
...
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, MAD-FAVORABLE, MILD-LIFESTYLE, MAD-WORKUP`
...
**Patient:** F, BMI 23, **no study**, ISI 24  
**Phenotypes:** _none_  
**Plan (ranked):** `SLEEP-STUDY, CBTI`
...
**Plan (ranked):** `CPAP, WEIGHT, SURG, SURGALT, SURGERY-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
...
### 17. Prior UPPP
**Patient:** M, BMI 30, AHI 25, **prior UPPP**, FTP III  
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, WEIGHT, MAD, MAD-WORKUP, SURGERY-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
...
### 18. Prior MAD failed
**Patient:** F, BMI 28, AHI 15, **prior MAD**  
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, SURG, MAD, SURGERY-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
...
**Plan (ranked):** `CPAP, MAD-FAVORABLE, REM-CHECK, REM-MAD, MAD-WORKUP`
...
### 20. High loop gain
**Patient:** M, BMI 29, AHI 25, CSR 15%, pAHIc 12  
**Phenotypes:** High Loop Gain  
**Plan (ranked):** `CPAP-FIXED, CPAP, ASV-SAFETY, MAD, MAD-WORKUP, CENTRAL-PSG-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
...
**Plan (ranked):** `CPAP, WEIGHT, MAD, HB-URG, MAD-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
...
**Patient:** M, BMI 28, AHI 16, NOSE 60, supine 32 / non-supine 6  
**Phenotypes:** Positional OSA, Nasal-Resistance Contributor  
**Plan (ranked):** `CPAP, POS, MAD, NASAL-OPT, MAD-WORKUP, SURGERY-WORKUP, OXYGEN-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, ANATOMY-WORKUP`
...
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, WEIGHT, MAD, MAD-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, ANATOMY-WORKUP, HNS-WORKUP, NASAL-WORKUP`
...
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, WEIGHT, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, ANATOMY-WORKUP, HNS-WORKUP, NASAL-WORKUP`
...
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, MAD, MAD-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, SLEEP-STAGE-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
...
**Patient:** M, BMI 27, AHI 12, nadir 88%, apnea 3 / hypopnea 9, ISI 4  
**Phenotypes:** Low Arousal Threshold  
**Plan (ranked):** `CPAP, CPAP-OPT, MAD-FAVORABLE, MAD-WORKUP`
...
**Phenotypes:** REM-Predominant OSA  
**Plan (ranked):** `CPAP, MAD, REM-CHECK, REM-MAD, MAD-WORKUP, OXYGEN-WORKUP, POSITION-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
...
**Patient:** M, BMI 33, AHI 12, tonsils 1, FTP II  
**Phenotypes:** _none_  
**Plan (ranked):** `CPAP, WEIGHT, MAD-FAVORABLE, MILD-LIFESTYLE, MAD-WORKUP`
...
**Patient:** M, BMI 30, AHI 40, REM 40 / NREM 18  
**Phenotypes:** Poor Muscle Responsiveness  
**Plan (ranked):** `CPAP, WEIGHT, OXYGEN-WORKUP, POSITION-WORKUP, ENDOTYPE-WORKUP, NASAL-WORKUP`
