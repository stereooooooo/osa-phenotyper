...
| ER-2026-07-19-RC-STRESS | 2026-07-19 | 2026-07-19 | Combined release-candidate regression across COMISA, HB, PAP-download interpretation, limited WatchPAT routing, nasal findings, positional OSA, oral appliances, and HGNS context | Previously verified primary sources and reviews listed in ER-2026-07-19-WATCHPAT, PAP, HB, NONPAP-PREDICTION, and COMISA; no new literature claim introduced | Five cross-cutting cases found no contradictory routing, unsupported response tier, patient leakage of technical study-quality warnings, autonomous PAP action, or HB-driven treatment allocation. One communication defect was corrected so an unspecified PAP mode remains generic rather than being labeled CPAP. | DX-02, DX-04, PH-05, PH-07, TX-01, TX-02, TX-03, PAP-01, PAP-02 | Tests 203-207 and all prior regressions pass; 1,679 assertions passed locally; clinician approval and deployment pending |
