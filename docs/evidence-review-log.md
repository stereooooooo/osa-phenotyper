...
|---|---|---|---|---|---|---|---|
| ER-2026-08-13-ANATOMY-SURGERY | 2026-08-13 | 2026-08-13 | Adult OSA surgical referral and procedure selection; Friedman staging; adult tonsillectomy and palatal surgery; DISE; nasal procedures; MMA | AASM 2021 surgical-referral guideline; Friedman 2004 and Choi 2016; Camacho 2016, Senchak 2015, and TEAMUP 2022; SAMS 2020; Gillespie 2013, Kezirian 2010, Green 2019, Meraj 2017, and Di Bari 2024; Zaghi 2016 and ERS 2021. Full method, links, and limitations are in `research/anatomy-surgical-selection-primary-sources.md`. | Retain Friedman stage as directional historical context only for isolated palatal surgery; retire Stage-III routing to tongue-base surgery, HGNS, MMA, or DISE. Enlarged tonsils can support a tonsillectomy consultation without a guaranteed response or automatic palatal procedure. DISE is device-, procedure-, and question-specific rather than a universal surgery prerequisite. The exploratory high-anatomy composite and nasal-contributor phenotype cannot independently trigger generic pharyngeal surgery. Preserve current unilateral-Inspire CCC exclusion and the clinician-confirmed DISE plus inferior turbinate reduction demo plan. | PH-01, TX-07 | Narrow treatment-ranking and workup safety correction; paired regressions and counterexamples updated; complete headless suite passed 2,194 assertions; clinician acceptance and deployment remain pending |
