...
- **Clinician reviewer and decision:** Raymond Brown, MD, acceptance pending
- **Commit:** This audit-remediation change set; exact hash recorded in Git history
- **Deployed build:** Not deployed; current pilot remains `e12734f`
