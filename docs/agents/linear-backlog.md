...
- Acceptance: localhost-only `?demo=inspire`; synthetic browser-memory data; real intake form and import-review UI; candidacy counterexample; automated smoke coverage.
