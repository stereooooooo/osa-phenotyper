...
| Clinical logic reviewed through | `ER-2026-07-19-FOLLOWUP`; clinician review pending; 1,859 regression assertions passed locally; combined implementation is not deployed |
