...
| Clinical logic reviewed through | `ER-2026-07-20-AUDIT-REMEDIATION`; clinician acceptance pending; 2,020 regression assertions passed locally; candidate is not deployed |
...
|---|---|---|---|---|---|---|---|
| DX-01 | Negative, inconclusive, or inadequate HSAT | Clinician flag and draft diagnostic-testing pathway; patient handout names PSG as ordered only after clinician selection and confirmation. A positive numerical signal from a nondiagnostic home recording is described as possible rather than as confirmed OSA or a confirmed severity category. | E1 | Guideline aligned with local signoff workflow | `citations.md`, Diagnostic Testing | Treating another plausible contributor before PSG is individualized sequencing and has not been directly compared with PSG-first care | Expert agreement on PSG timing; missed clinically important sleep-disordered breathing; false definitive patient labeling |
