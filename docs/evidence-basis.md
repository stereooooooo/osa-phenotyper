...
| Clinical logic reviewed through | `ER-2026-08-13-ANATOMY-SURGERY`; anatomy and surgical-selection safety alignment verified with 2,194 complete headless-suite assertions; see [`test-matrix-results.md`](test-matrix-results.md) |
...
| Physiology-phenotype source review | [`research/physiology-phenotypes-primary-sources.md`](research/physiology-phenotypes-primary-sources.md) |
| Anatomy and surgical-selection source review | [`research/anatomy-surgical-selection-primary-sources.md`](research/anatomy-surgical-selection-primary-sources.md) |
...
| PH-01 | High anatomical contribution | Composite of BMI, neck, tonsils, Friedman tongue position, and severity. It describes a possible structural contributor but cannot independently identify a correctable target, trigger surgery, or rank a procedure. | E3/E5 | Exploratory | `citations.md`, OSA Phenotyping and Friedman Staging | The app's exact composite and confidence tiers have not been externally validated; BMI, neck size, and AHI do not localize an operative target | Agreement with expert anatomy assessment without using the composite as a treatment-response score |
| PH-02 | Exploratory low-arousal-threshold screen | Only the complete three-variable Edwards classifier can create a clinician-only signal; confidence is capped at Moderate and no treatment is selected from it. A partial 2-of-2 score is not active. | E4 | Exploratory | `citations.md`, Arousal Threshold | The model had internal leave-one-out validation, not independent external validation; it is a screening proxy rather than a measured trait and depends on scoring and sampling | Agreement with a method-specific validated arousal-threshold estimate; calibration and clinical utility in the target population |
| PH-03 | Loop-gain phenotype from routine summary data | Inactive. Central and periodic-breathing findings remain diagnostic and safety signals, but cannot create a loop-gain label or select PAP mode, oxygen, acetazolamide, or ASV. | E4 | Inactive or future | `citations.md`, Loop Gain and Central Sleep Apnea | Central-event and CSR summaries are not equivalent to measured loop gain; LG0, LG1, and LG at natural frequency are method-distinct | Method-specific raw-signal validation, external thresholds, prospective treatment-utility evidence |
| PH-04 | Poor muscle responsiveness from REM/NREM AHI | Inactive. REM/NREM AHI remains available for the separate REM-predominant OSA pattern but cannot infer muscle compensation or route HGNS. | E4 | Inactive or future | `citations.md`, OSA Phenotyping | REM/NREM AHI is not a validated measurement of upper-airway muscle responsiveness | Raw-signal or reference-physiology validation and prospective treatment-utility evidence |
...
| PH-07 | Event-linked hypoxic burden research signal | Uses only respiratory-event-linked desaturation area divided by sleep time. The 30 %min/h boundary is an exploratory local signal; 73.1 and 87.1 are displayed only as post hoc research-cohort context. Confidence is capped at Moderate and HB alone cannot select, withhold, or rank treatment. Method and provenance must be known before a value is compared with published research cut points. | E2/E3/E5 | Evidence informed, exploratory local signal | `citations.md`, Event-Linked Hypoxic Burden | No universally validated clinical categories or prospective HB-guided treatment-allocation trial exists. Commercial WatchPAT output, custom PAT-derived burden, scored-event HB, and HBOxi are not assumed numerically interchangeable without method-specific validation. | Reproducibility, method provenance and agreement, cardiovascular-risk discrimination, clinician interpretation, and prospective treatment interaction |
...
| TX-01 | COMISA sequencing and safety | ISI at least 15 is interpreted as the validated moderate-to-severe insomnia-symptom range. With objectively established AHI at least 5, it flags a COMISA screening phenotype, not a standalone chronic-insomnia diagnosis. The clinician must confirm frequency, duration, daytime impact, adequate sleep opportunity, and alternative causes. CBT-I is offered early; PAP may begin concurrently or sequentially based on severity, substantial nocturnal hypoxemia, sleepiness, safety-sensitive duties, access, and preference. High baseline ESS triggers early sleepiness and safety monitoring during bedtime restriction, not a CBT-I contraindication. PAP mode and settings remain individualized. | E2/E5 | Evidence informed with a validated symptom boundary and local screening combination | `citations.md`, COMISA | COMISA definitions are heterogeneous, and the strongest treatment trials generally required confirmed insomnia and AHI at least 15, so application to a mild-OSA numerical screen is indirect. Adherence benefit varies across trials; no validated rule selects sequence, PAP mode, pressure range, or CBT-I pacing for an individual. | Clinician confirmation of the screen and insomnia diagnosis, ISI, PAP uptake and adherence, sleepiness trajectory, safety events, patient-reported benefit, sequence chosen, and clinician override rate |
...
| TX-04 | Weight-management and tirzepatide pathway | Weight management is adjunctive and individualized. The named Zepbound OSA pathway is limited to adults with obesity and moderate-to-severe OSA, alongside reduced-calorie diet and increased physical activity. It is kept separate from broader chronic-weight-management eligibility. Medication clearance, dosing, contraindications, interactions, and tolerability remain under prescriber review; treatment is not de-escalated solely because weight falls. | E1/E2 | Guideline and FDA-label aligned | `citations.md`, Weight Management | SURMOUNT-OSA provides 52-week group-average effects, not an individual response probability, lifetime durability, or a PAP-discontinuation rule. No fixed weight change predicts AHI or snoring response. | Weight change, AHI, symptoms, adverse effects, persistence, objective reassessment before de-escalation, and clinician override rate |
...
| TX-06 | Primary-snoring treatment pathway after OSA is not identified | Conservative contributors are addressed first; for adults with overweight or obesity, weight management may reduce snoring but no pound or percentage threshold is promised. An oral appliance remains an evidence-based option when requested; nasal surgery is presented only as an adjunct for documented obstruction with uncertain snoring response. | E1/E2/E5 | Guideline aligned with local signoff workflow | `citations.md`, Primary Snoring | Direct weight-loss evidence for snoring is sparse, old, small, and confounded; partner-reported and objective snoring measures are poorly standardized. Isolated nasal-surgery evidence is inconsistent and AAO-HNS did not reach consensus on septoplasty for primary snoring. | Weight and snoring tracked separately, partner-reported snoring, validated SOS, objective acoustic burden, persistence, adverse effects, and treatment escalation |
| TX-07 | Upper-airway surgery referral and procedure-specific context | AASM referral criteria can support a sleep-surgeon discussion, but the app does not select an operation from referral eligibility. Friedman stage supplies historical directional context only for isolated palatal surgery: Stage I is more supportive and Stage III less supportive. Stage III cannot route tongue-base surgery, HGNS, MMA, or DISE. Enlarged tonsils may support a tonsillectomy consultation without guaranteeing control or automatically adding palatal surgery. The exploratory anatomy composite and nasal-contributor phenotype cannot independently trigger generic pharyngeal surgery. DISE is conditional on the selected device/procedure or an unresolved planning question, except where current device labeling or a clinician-confirmed plan makes it required. | E1/E2/E3/E4/E5 | Guideline aligned for referral; evidence informed for tonsil and palatal context; local governance for revision workflow | `citations.md`, Friedman Staging System, Surgical Selection, and DISE Evidence; `research/anatomy-surgical-selection-primary-sources.md` | Friedman evidence is procedure-specific, older, selected, and examiner-dependent; tonsil and multilevel trials studied selected populations; DISE scoring has variable interrater reliability and mixed outcome evidence; MMA evidence is mainly observational and does not create an individual selection rule | Procedure-specific objective response and residual OSA, symptoms, complications, target-selection agreement, DISE use and plan-change rate, clinician override rate, and confirmation that named procedures require clinician signoff |
...
| SAF-01 | ASV device safety | The app does not autonomously recommend ASV and no longer applies a blanket LVEF-at-most-45% contraindication to every current ASV device. If ASV is considered after confirmed CSA evaluation, the treating specialist must use the current device algorithm, labeling, evidence, heart-failure context, and shared decision-making. Existing heart-failure workflows may still request the latest numeric LVEF for broader cardiopulmonary care. | E1 | Guideline aligned | `citations.md`, Central Sleep Apnea | The AASM notes that algorithms and safety data differ; the mortality signal occurred with one device no longer manufactured. The app does not capture every device-specific variable. | Specialist concordance, device/label verification, safety events, and inappropriate autonomous ASV routing |
| SAF-02 | Central or periodic-breathing findings | Home-study signals trigger clinical review and PSG confirmation when clinically important; PSG CAI at least 5/h prompts etiologic review. These findings cannot create a loop-gain diagnosis or automatically select fixed CPAP, oxygen, acetazolamide, BPAP, or ASV. | E1/E3/E5 | Guideline aligned diagnostic boundary with local review trigger | `citations.md`, Diagnostic Testing and Central Sleep Apnea | Home-device central estimates depend on sensor configuration; CAI alone does not establish one CSA cause or treatment | PSG confirmation, etiologic classification, inappropriate treatment avoidance, and clinician override rate |
| SAF-03 | Substantial nocturnal hypoxemia | ODI >50/h, T90 >20%, nadir SpO2 <75%, or area below 90% >2/h triggers separate clinician review, timely effective treatment of confirmed OSA, consideration of non-OSA contributors, and objective confirmation of oxygen control. These metrics never create the event-linked HB phenotype. | E2/E3/E5 | Evidence informed local safety boundary | `citations.md`, Event-Linked Hypoxic Burden and Conventional Nocturnal Hypoxemia | T90 >20% and nadir <75% have directional retrospective-cohort context, but the exact four-part trigger set is a conservative local review rule rather than a prospectively validated universal action threshold. Device and denominator differences matter, and causal attribution requires clinical evaluation. | Clinician agreement, non-OSA diagnosis yield, treatment urgency, follow-up oxygen control, method-specific false-alert rate, and clinician override rate |
...
| PAP-04 | Clinician-only PAP adherence support needs | When PAP is active, planned, or being retried, documented potentially remediable barriers such as mask/interface problems, leak, dryness, claustrophobia, sleep-onset difficulty, clinically significant insomnia symptoms, or symptomatic nasal obstruction can trigger proactive education, targeted troubleshooting, and early objective review. The output explicitly says this is not a prediction that PAP will fail. Demographics, routine severity, socioeconomic labels, and exploratory endotypes cannot create the flag or demote PAP. | E1/E2/E3/E5 | Guideline aligned support intervention with evidence-informed local trigger set | `citations.md`, Patient Behavior and PAP Counseling | No transportable externally validated baseline individual adherence model was identified. Barrier associations are heterogeneous, early use partly measures the outcome already underway, and resolving a correlated barrier does not guarantee adherence. | Flag prevalence and false-positive rate, intervention completion, objective use after support, leak and comfort change, persistence, patient experience, treatment-ranking parity, and clinician override rate |
