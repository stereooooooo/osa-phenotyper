...
| Clinical logic reviewed through | `ER-2026-08-13-PHYSIOLOGY-ENDOTYPES`; physiology-endotype safety alignment verified with 2,164 complete headless-suite assertions; see [`test-matrix-results.md`](test-matrix-results.md) |
