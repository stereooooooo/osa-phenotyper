...
| Clinical logic reviewed through | `ER-2026-07-19-COMISA`; clinician review pending; 1,542 regression assertions passed locally; implementation is not deployed |
