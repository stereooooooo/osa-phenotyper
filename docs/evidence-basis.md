...
| Clinical logic reviewed through | `ER-2026-07-19-HGNS-PLAN`; clinician review pending; 1,845 regression assertions passed locally; combined implementation is not deployed |
