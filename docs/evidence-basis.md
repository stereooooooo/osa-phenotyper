...
| Clinical logic reviewed through | `ER-2026-08-13-ISI-PAP-SNORING-SIGNOFF`; clinician-approved runtime alignment verified with 193 evidence-documentation assertions and 2,149 complete headless-suite assertions; see [`test-matrix-results.md`](test-matrix-results.md) |
