...
| Clinical logic reviewed through | `ER-2026-07-20-VISIT-CONTEXT`; clinician acceptance pending; 1,910 regression assertions passed locally; build `e12734f` is deployed to the clinical pilot for testing |
