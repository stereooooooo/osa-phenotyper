...
| Clinical logic reviewed through | `ER-2026-07-20-VISIT-CONTEXT`; clinician review pending; 1,910 regression assertions passed locally; combined implementation is not deployed |
